function Pt = ThinPlateSpline(xs,xt,Ps)
% Thin-plate spline it is a warping technique described by Fred L. Bookstein
...
%
% Input:
%   - xs is the source Nx2 control points,
%   - xt is the target Nx2 target points,
